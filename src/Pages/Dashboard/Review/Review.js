        ...
        <div>
            ...
            <form className='mx-auto' onSubmit={handleSubmit(onSubmit)}>
                <div style={{ maxWidth: '500px', margin: '0 auto' }}>
                    ...
                    <textarea className='form-control mb-4' required placeholder='Your Comment' type='text' {...register("comment")} />
                    <input className='form-control mb-4' required placeholder='Ratting by number 1-5' type='number' {...register("ratting")} />
                    <input className='btn btn-primary mb-4' type="submit" value='Review' />
                </div>
            </form>
        </div>
    );
